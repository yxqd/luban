...
class Table(Element):
    ...
    model = Element.descriptors.reference(name='model')
    view = Element.descriptors.reference(name='view')
    data = Element.descriptors.lists(name='data')
    oncellchanged = Element.descriptors.reference(name='oncellchanged')
